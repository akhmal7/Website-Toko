    ...
    <div class="box">
      ...
      ?>
        <!--<a href="detail-produk.php?id<?php echo $p['product_id'] ?>">-->
          <div class="col-4">
            <div class="image">
              <img src="produk/<?php echo $p['product_image'] ?>" style="margin-bottom: 30px;" >
            ...
            <div class="phone">
              ...
              <p><a href="https:/api.whatsapp.com/send?phone=<?php echo $a->admin_telp?>&text=Saya tertarik dengan produk <?php echo $p['product_name']?> dengan harga RP: <?php echo number_format($p['product_price'])?>Atas pelayanan Admin <?php echo $a->admin_name ?>" class="social-media-icon" href="https://link_social_mendia_anda"><span class="fab fa-whatsapp"></span></a></p>
